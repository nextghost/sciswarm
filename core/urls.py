...
account_patterns = [
    ...
    url(r'^paper_managers/?\Z', user.PaperManagersListView.as_view(),
        name='user_paper_managers_list'),
    url(r'^delegating_authors/?\Z', user.DelegatingAuthorsListView.as_view(),
        name='user_delegating_authors_list'),
...
person_patterns = [
    ...
    url(r'^(?P<username>[^/]+)/delegate/?\Z',
        user.PaperManagementDelegationView.as_view(),
        name='delegate_paper_management'),

# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2018-11-26 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Paper', verbose_name='paper')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
                'ordering': ('scheme', 'identifier'),
            },
        ...
        migrations.AddField(
            ...
            name='author_alias',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.UserAlias', verbose_name='author'),
        ),
        migrations.AddField(
            model_name='paperauthorreference',
            name='paper',
        ...
        migrations.AddField(
            model_name='paper',
            name='authors',
            field=models.ManyToManyField(through='core.PaperAuthorReference', to='core.UserAlias'),
        ),
        migrations.AddField(
            model_name='paper',
            name='bibliography',
        ...
        migrations.AddField(
            model_name='paper',
            name='posted_by',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posted_paper_set', to=settings.AUTH_USER_MODEL, verbose_name='posted by'),
        ),
